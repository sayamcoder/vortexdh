...
$message = $__bag->first($__errorArgs[0]); ?> 
                    <span class="text-red-400 text-[11px] mt-1.5 block font-medium px-1 italic"><?php echo e($message); ?></span> 
                <?php unset($message);
            ...
            <div>
                <div class="flex justify-between items-center mb-2 px-1">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-medium text-indigo-400 hover:text-indigo-300 transition-colors">Forgot?</a>
                    <?php endif; ?>
                </div>
    ...
    <?php if(Route::has('register')): ?>
        <div class="mt-8 text-center">
            <p class="text-sm text-zinc-500 font-medium">
                New to the platform? 
                <a href="<?php echo e(route('register')); ?>" class="text-indigo-400 hover:text-white font-bold transition-colors ml-1 underline underline-offset-4 decoration-indigo-500/30 hover:decoration-white">Create an account</a>
            </p>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/auth/login.blade.php ENDPATH**/ ?>