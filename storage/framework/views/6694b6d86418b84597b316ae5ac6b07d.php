...
<?php $__env->startSection('title', 'Manage Ticket #' . $ticket->id); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto animate-fade">
    <div class="flex justify-between items-center mb-6">
        <a href="<?php echo e(route('admin.tickets')); ?>" class="text-zinc-500 hover:text-white text-sm">&larr; Back to List</a>
        <?php if($ticket->status !== 'closed'): ?>
            <form action="<?php echo e(route('admin.tickets.close', $ticket->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div class="space-y-6 mb-8">
        ...
        <div class="flex gap-4 <?php echo e($msg->user->is_admin ? 'flex-row-reverse' : ''); ?>">
            ...
            <div class="max-w-2xl p-4 rounded-2xl border 
                <?php echo e($msg->user->is_admin ? 'bg-red-500/5 border-red-500/10 text-zinc-300' : 'bg-zinc-900 border-white/5 text-zinc-300'); ?>">
                <div class="flex justify-between items-center mb-2 gap-4">
                    <span class="text-xs font-bold <?php echo e($msg->user->is_admin ? 'text-red-400' : 'text-zinc-400'); ?>"><?php echo e($msg->user->name); ?></span>
    ...
    <!-- Admin Reply Form -->
    <form action="<?php echo e(route('admin.tickets.reply', $ticket->id)); ?>" method="POST" class="bg-zinc-900 border border-white/5 rounded-xl p-4 border-l-4 border-l-red-500">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/admin/tickets/show.blade.php ENDPATH**/ ?>