...
<?php $__env->startSection('title', 'Commander Registry'); ?>
...
<div class="animate-fade-in-up">
    <div class="mb-8 flex justify-between items-end">
        ...
        <a href="<?php echo e(route('admin.index')); ?>" class="px-4 py-2 bg-gray-900 border border-gray-700 text-gray-300 hover:text-white rounded-lg text-sm font-bold transition-colors">
            &larr; Return to Base
        </a>
    </div>
...
<div class="mb-6 flex gap-4">
    ...
    <div class="px-4 py-2.5 bg-zinc-900 border border-white/5 rounded-xl flex items-center gap-2">
        ...
        <span class="text-xs font-bold text-zinc-300 uppercase tracking-widest"><?php echo e($users->total()); ?> Active Users</span>
    </div>
</div>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-vortex-purple/5 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-white font-bold text-sm"><?php echo e($user->name); ?></p>
                                    <p class="text-xs text-gray-500 font-mono"><?php echo e($user->email); ?></p>
                        ...
                        <td colspan="4" class="px-0 py-0 align-middle">
                            <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST" class="flex items-center w-full h-full px-6">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="w-1/4 pr-6">
                                    <div class="relative group/input">
                                        ...
                                        <input type="number" name="coins" value="<?php echo e($user->coins); ?>" class="w-full bg-black/40 border border-gray-700 text-yellow-500 font-mono font-bold text-sm rounded-md py-2 pl-9 focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500 block transition-all">
                                    </div>
                                </div>

                                <!-- Server Slots -->
                                <div class="w-1/6 text-center pr-6 flex items-center justify-center space-x-2">
                                    <span class="text-gray-500 text-xs font-mono"><?php echo e($user->servers_count); ?> /</span>
                                    <input type="number" name="max_servers" value="<?php echo e($user->max_servers); ?>" class="w-12 bg-black/40 border border-gray-700 text-white font-mono text-sm rounded-md py-1 text-center focus:border-vortex-purple focus:ring-1 focus:ring-vortex-purple">
                                </div>

                                <!-- Resources -->
                                <div class="flex-1 flex justify-center space-x-2">
                                    <input type="number" name="max_ram" value="<?php echo e($user->max_ram); ?>" class="w-20 bg-black/40 border border-gray-700 text-vortex-purple font-mono text-sm rounded-md py-1 text-center focus:border-vortex-purple focus:ring-1 focus:ring-vortex-purple" placeholder="RAM">
                                    <input type="number" name="max_cpu" value="<?php echo e($user->max_cpu); ?>" class="w-16 bg-black/40 border border-gray-700 text-blue-400 font-mono text-sm rounded-md py-1 text-center focus:border-blue-500 focus:ring-1 focus:ring-blue-500" placeholder="CPU">
                                    <input type="number" name="max_disk" value="<?php echo e($user->max_disk); ?>" class="w-20 bg-black/40 border border-gray-700 text-green-400 font-mono text-sm rounded-md py-1 text-center focus:border-green-500 focus:ring-1 focus:ring-green-500" placeholder="DISK">
                                </div>
    ...
    <a href="<?php echo e(route('admin.users.impersonate', $user->id)); ?>" class="px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-[10px] font-bold rounded-md transition-colors uppercase border border-white/5">
        Login As
    </a>
                                </div>
                            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/admin/users.blade.php ENDPATH**/ ?>