...
<?php $__env->startSection('title', 'Resource Store'); ?>
...
<div class="animate-fade space-y-12">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 bg-zinc-900/50 border border-white/5 rounded-2xl p-8 shadow-sm">
        ...
        <div class="w-full lg:w-96">
            ...
            <form action="<?php echo e(route('shop.redeem')); ?>" method="POST" class="relative group">
                <?php echo csrf_field(); ?>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-zinc-900 border border-white/5 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:border-<?php echo e($config['color']); ?>-500/30 group shadow-sm">
                    
                    <div>
                        <!-- Icon -->
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center mb-6 text-<?php echo e($config['color']); ?>-400 bg-<?php echo e($config['color']); ?>-500/10 border border-<?php echo e($config['color']); ?>-500/20 group-hover:scale-110 transition-transform duration-500">
                        ...
                        <h3 class="text-lg font-semibold text-white mb-1"><?php echo e($item->name); ?></h3>
                        <p class="text-sm text-zinc-500 mb-8 leading-relaxed">Increase your account's global hardware allocation immediately.</p>
                    </div>

                    <!-- Purchase Button -->
                    <form action="<?php echo e(route('shop.buy')); ?>" method="POST" class="mt-auto">
                        <?php echo csrf_field(); ?> 
                        <input type="hidden" name="item" value="<?php echo e($item->type); ?>">
                        ...
                        <button type="submit" class="w-full flex items-center justify-between px-4 py-3 bg-zinc-950 border border-zinc-800 hover:bg-zinc-800 hover:border-zinc-700 rounded-xl transition-all group/btn">
                            ...
                            <div class="flex items-center text-amber-500 font-bold text-sm bg-amber-500/5 px-2 py-1 rounded-lg border border-amber-500/10">
                                <?php echo e(number_format($item->cost)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/shop.blade.php ENDPATH**/ ?>