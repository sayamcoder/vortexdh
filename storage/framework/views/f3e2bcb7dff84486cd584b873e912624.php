...
<?php $__env->startSection('title', 'Reward Hub'); ?>
...
<div class="animate-fade">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="relative bg-zinc-900 border border-white/5 rounded-3xl p-8 overflow-hidden shadow-2xl group transition-all duration-500 <?php echo e($canClaim ? 'hover:border-emerald-500/50' : ''); ?>">
                ...
                <div class="absolute top-0 right-0 w-96 h-96 rounded-full blur-[100px] pointer-events-none transition-all duration-1000 
                    <?php echo e($canClaim ? 'bg-emerald-500/20 group-hover:bg-emerald-500/30' : 'bg-zinc-800/50'); ?>"></div>
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div class="w-32 h-32 flex-shrink-0 rounded-2xl flex items-center justify-center border-2 shadow-inner transition-all duration-500
                        <?php echo e($canClaim ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400 animate-pulse shadow-[0_0_30px_rgba(16,185,129,0.2)]' : 'bg-zinc-950 border-zinc-800 text-zinc-600'); ?>">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        <div class="inline-flex items-center px-2.5 py-0.5 rounded-md text-[10px] font-black uppercase tracking-widest mb-3 border 
                            <?php echo e($canClaim ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-zinc-800 text-zinc-400 border-zinc-700'); ?>">
                            <?php echo e($canClaim ? 'Ready to Open' : 'Charging...'); ?>
                        ...
                        <?php if($canClaim): ?>
                            <form action="<?php echo e(route('rewards.claim')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <div class="inline-flex items-center justify-center w-full md:w-auto px-8 py-3.5 bg-zinc-950 border border-zinc-800 text-zinc-500 font-mono font-bold rounded-xl cursor-not-allowed">
                                ...
                                NEXT DROP IN: <span class="ml-2 text-indigo-400"><?php echo e($timeLeft); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/rewards.blade.php ENDPATH**/ ?>