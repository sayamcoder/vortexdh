...
<div class="max-w-5xl mx-auto animate-fade">
    ...
    <div class="relative bg-gradient-to-r from-indigo-900/30 to-zinc-900 border border-indigo-500/20 rounded-2xl p-8 mb-8 overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="w-full md:w-auto bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl p-2 flex items-center">
                <code class="px-4 text-indigo-300 font-mono text-sm" id="ref-link"><?php echo e(url('/register?ref=' . $user->referral_code)); ?></code>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div class="bg-zinc-900 border border-white/5 rounded-xl p-6">
            ...
            <p class="text-3xl font-bold text-white"><?php echo e($referredUsers->count()); ?></p>
        </div>
        ...
        <div class="bg-zinc-900 border border-white/5 rounded-xl p-6">
            ...
            <p class="text-3xl font-bold text-white"><?php echo e(number_format($user->referral_earnings)); ?> <span class="text-sm font-normal text-zinc-500">Coins</span></p>
        </div>
    ...
    <div class="bg-zinc-900 border border-white/5 rounded-xl overflow-hidden">
        ...
        <div class="divide-y divide-white/5">
            <?php $__empty_1 = true; $__currentLoopData = $referredUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between px-6 py-4 hover:bg-white/[0.02] transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-zinc-200"><?php echo e($referral->name); ?></p>
                        <p class="text-xs text-zinc-500">Joined <?php echo e($referral->created_at->diffForHumans()); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/referrals.blade.php ENDPATH**/ ?>