...
<body class="bg-[#050505] text-zinc-400 relative overflow-x-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
        ...
        <div class="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-xs font-bold uppercase tracking-widest text-white hover:text-indigo-400 transition-colors">Console &rarr;</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Sign in</a>
                    <a href="<?php echo e(route('register')); ?>" class="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black uppercase tracking-widest rounded-lg transition-all active:scale-95 shadow-lg shadow-indigo-600/20">
                        Launch World
                    </a>
                <?php endif; ?>
            </div>
    ...
    <section class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div class="relative z-10 text-center max-w-6xl px-6">
            ...
            <div class="reveal delay-3 flex flex-col sm:flex-row justify-center items-center gap-5">
                <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto px-10 py-5 bg-white hover:bg-zinc-200 text-black font-black uppercase tracking-widest text-[11px] rounded-2xl transition-all shadow-[0_20px_40px_rgba(255,255,255,0.1)] hover:-translate-y-1 active:scale-95">
                    Start Your Instance
                </a>
    ...
    <section class="py-32 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block px-12 py-5 bg-white hover:bg-zinc-200 text-black font-black uppercase tracking-[0.2em] text-xs rounded-2xl transition-all shadow-2xl active:scale-95">
    ...
    <footer class="py-16 border-t border-white/5 bg-[#050505] relative z-10">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p class="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">
                &copy; <?php echo e(date('Y')); ?> VortexDash Global Infrastructure. All protocols secured.
            </p>
...
</html><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/welcome.blade.php ENDPATH**/ ?>