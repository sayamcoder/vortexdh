...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - VortexDash</title>
...
<div class="relative z-10 flex h-screen overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto custom-scroll px-3 py-6 space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('dashboard') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('servers.create')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('servers.create') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('leaderboard')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('leaderboard') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
    ...
    Leaderboard
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="<?php echo e(route('shop')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('shop') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('billing')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('billing') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('referrals')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('referrals') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                            <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            Affiliates
                        </a>
                        <!-- Rewards Link -->
<a href="<?php echo e(route('rewards')); ?>" class="group relative flex items-center py-3.5 px-4 rounded-xl transition-all duration-300 overflow-hidden <?php echo e(request()->routeIs('rewards') ? 'bg-emerald-500/10 border border-emerald-500/20' : 'hover:bg-white/5 border border-transparent'); ?>">
    <div class="absolute left-0 top-0 h-full w-1 rounded-r-full transition-all duration-300 <?php echo e(request()->routeIs('rewards') ? 'bg-emerald-500' : 'bg-transparent group-hover:bg-gray-600'); ?>"></div>
    
    <svg class="w-5 h-5 mr-3 transition-colors <?php echo e(request()->routeIs('rewards') ? 'text-emerald-400 drop-shadow-[0_0_5px_rgba(52,211,153,0.5)]' : 'text-gray-500 group-hover:text-gray-300'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path></svg>
    
    <span class="font-bold text-sm tracking-wide transition-colors <?php echo e(request()->routeIs('rewards') ? 'text-white' : 'text-gray-400 group-hover:text-white'); ?>">Reward Hub</span>
    ...
    <span class="ml-auto flex h-2 w-2 relative">
        ...
        <div>
            ...
            <div class="space-y-0.5">
                <a href="<?php echo e(route('account.api')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('account.api') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                ...
                <a href="<?php echo e(route('account.activity')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('account.activity') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="<?php echo e(route('account')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('account') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
...
<a href="<?php echo e(route('support')); ?>" class="group relative flex items-center py-3.5 px-4 rounded-xl transition-all duration-300 overflow-hidden <?php echo e(request()->routeIs('support*') ? 'bg-white/5 text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
    <div class="absolute left-0 top-0 h-full w-1 rounded-r-full transition-all duration-300 <?php echo e(request()->routeIs('support*') ? 'bg-indigo-500' : 'bg-transparent group-hover:bg-gray-600'); ?>"></div>
    ...
    <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="<?php echo e(route('admin.index')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.index') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                            <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                            Admin Control
                        </a>
                        <a href="<?php echo e(route('admin.activity')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.activity') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                            <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                            Audit Logs
                        </a>
                        <a href="<?php echo e(route('admin.announcements')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.announcements') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                            <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path></svg>
                            Broadcasts
                        </a>
                        <a href="<?php echo e(route('admin.vouchers')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.vouchers') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('admin.nodes')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.nodes') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
    <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
    Infrastructure
</a>
<a href="<?php echo e(route('admin.tickets')); ?>" class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.tickets') ? 'bg-red-500/10 text-red-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'); ?>">
            ...
            <header class="h-16 flex items-center justify-between px-6 border-b border-white/5 bg-[#09090b]/80 backdrop-blur-md z-30">
                ...
                <div class="ml-auto flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-900 border border-white/5 hover:border-yellow-500/30 transition-colors">
                        ...
                        <span class="text-xs font-medium text-zinc-300"><?php echo e(number_format(Auth::user()->coins)); ?> Coins</span>
                    </div>
                </div>
            </header>
...
<?php if(Session::has('impersonate')): ?>
    <div class="fixed bottom-6 right-6 z-[100] bg-red-600 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-4 animate-bounce border border-white/20">
        <div class="flex flex-col">
            ...
            <span class="text-sm font-bold">Viewing as <?php echo e(Auth::user()->name); ?></span>
        </div>
        <a href="<?php echo e(route('admin.users.stop-impersonation')); ?>" class="bg-black/20 hover:bg-black/40 px-3 py-1.5 rounded-lg text-xs font-black transition-all">
            RETURN TO BASE
        </a>
    </div>
<?php endif; ?>
</html><?php /**PATH E:\SSSSSS\stats\vortexdash\resources\views/layouts/app.blade.php ENDPATH**/ ?>